    ...
    render() {
        ...
        <View style={{paddingHorizontal:-1}}>
            <CardItem style={{backgroundColor:backgroundColor}}>
                ...
                <Right>
                    <Icon name='more-vertical' type='Feather' style={{color:text}} />
                </Right>
            </CardItem>
            <CardItem cardBody>
              <Image source={{uri: 'https://images.pexels.com/photos/2131830/pexels-photo-2131830.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500'}} style={{height: 200, width: null, flex: 1}}/>
            </CardItem>
